...
### EXAMPLE 2: Incidence data with default sample sizes or coverage values (not by pairs)
...
### EXAMPLE 3: Incidence data for all pairs of assemblages with user-specified sample sizes or coverage values
...
## Data information for phylogenetic diversity when all tree-depth values are considered
data(Brazil_rainforests)
data(Brazil_tree)
